...
- Subtitle: There is a lot of hype around AI. Let's ground your expectations.

### Uncertainty

- Title: How to navigate the uncertainty
- Subtitle: No one knows which scenario plays out. These practices keep your options open regardless.

### Framework

- Title: Our framework for AI adoption
- Subtitle: Similar to frameworks like OODA (Observe, Orient, Decide, Act) or the lean startup's Build Measure Learn, we focus on learning fast in an environment of uncertainty.

### Stage Focus

- Title: To start, think backwards
- Subtitle: Start from the back. Your strategy should run in reverse.
- Empty: Execute doesn't matter yet - scale only after the signal exists.
- Slide Empty: Scale only after the signal exists.

### Evaluate

- Eyebrow: Evaluate
- Title: Define the target
- Subtitle: What would great success look like?

### Experiment

- Eyebrow: Experiment
- Title: How to achieve the targets?
- Subtitle: Select use cases that would enable your targets.
...
- Eyebrow: Experiment
- Title: Who is going to do it?
- Subtitle: Assign an owner to each selected use case. Keep ownership close to the workflow.

### Enable

- Eyebrow: Enable
- Title: Make it possible
- Subtitle: Create the conditions to enable the use cases you just selected.
- Slide Title Prefix: Make it possible

### Next Steps

- Title: Commit to the next steps
- Subtitle: Star the actions that you want to start with.
...
- Enable: Lay the groundwork so experiments can succeed.
- Experiment: Run small bets against real workflows.
