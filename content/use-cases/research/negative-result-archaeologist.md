---
title: Negative-result archaeologist
category: use-cases
...
effort: 3
---
Negative-result archaeologist searches for registered-but-unpublished trials, retracted papers, discontinued programs, and other evidence that published literature systematically hides.

## What it is, how it works

- Adds failed or suppressed evidence to early source review.
- Improves coverage where publication bias would otherwise dominate.
- Is especially useful when public success stories are politically or professionally filtered.
